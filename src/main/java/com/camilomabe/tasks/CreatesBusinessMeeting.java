...
import com.camilomabe.interactions.GoesMeeting;
...
import static com.camilomabe.ui.MeetingPage.*;
import static com.camilomabe.ui.MenuBarPage.NEW_MEETING;
import static com.camilomabe.utils.Constants.*;
...
public class CreatesBusinessMeeting implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(Click.on(TXT_MEETING_TYPE));
        ...
        actor.attemptsTo(Click.on(SAVE_MEETING));
    }
}