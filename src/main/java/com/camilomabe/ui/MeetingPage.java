...
public class MeetingPage extends PageObject {
    ...
    public static final Target TXT_MEETING_TYPE = Target.the("Meeting type").located(By.xpath("//span[@id='select2-chosen-6']"));
    ...
    public static final Target SAVE_MEETING = Target.the("Save").located(By.xpath("//div[@class='tool-button save-and-close-button icon-tool-button']"));
